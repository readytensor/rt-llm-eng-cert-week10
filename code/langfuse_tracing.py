...
# Required: LANGFUSE_PUBLIC_KEY, LANGFUSE_SECRET_KEY, LANGFUSE_HOST, OPENAI_API_KEY
load_dotenv()
...
@observe(name="Step 1: Generate Draft")
...
@observe(name="Step 2: Critique Draft")
...
@observe(name="Step 3: Refine Draft")
...
@observe(name="Content Refinement Pipeline")
